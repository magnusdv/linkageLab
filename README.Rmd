---
title: "Linkage Lab: Kinship testing with linked markers"
...
Linkage Lab is a free interactive Shiny app for exploring how genetic linkage between markers affects likelihood ratios (LR) in forensic kinship testing.

For a given relationship comparison, the app shows how the LR for a marker pair depends on:
...
The app is built on the [pedsuite](https://magnusdv.github.io/pedsuite/) packages for pedigree analysis in R.
